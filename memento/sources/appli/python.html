...
<section id="principal">
  ...
  <h2 id="py_generalites"> Structure du code Python </h2>
...
<p>Les projets Python peuvent se structurer en modules ou en classes dans le cas de la programmation objet.</p>
  ...
  <h3>Exécution d'un module à partir du terminal</h3>
...
# -*-coding:Utf-8 -*</code></pre>
  ...
  <h3>Particularité du système Windows</h3>
...
os.system("pause")</code></pre>
  ...
  <h2 id="py_communiquer">Communiquer avec l'utilisateur</h2>
...
f"Hello {name}"</code></pre>
  ...
  <h3>Saisie d'une valeur par l'utilisateur</h3>
...
<!------LES PACKAGES------------->
  ...
  <h2 id="py_package">Les Packages</h2>
...
<p>Lorsqu'il n'y a aucun risque de confusion entre les fonctions de différents packages, on peut utiliser l'instruction
  ...
  <p>Parmi les packages importants, on trouve Matplotlib utilisé pour les graphiques, Numpy utilisé pour manipuler des séries de nombres, Pandas utilisé pour utiliser des données sous une forme de tableur.</p>
    ...
    <h3>Les packages et modules essentiels</h3>
...
setup(name = "librairie",
  ...
  zip_safe = False)</code></pre>
    ...
    <h2 id="py_package2">Créer un package avec Poetry</h2>
...
<h2 id="py_variable">Les types de variables</h2>
...
a, b = b, a</code></pre>
  ...
  <h3> Les principales opérations </h3>
  ...
  <h2 id="py_condition">Branchement conditionnel</h2>
...
instructions</code></pre>
  ...
  <h2 id="py_boucle"> Les boucles </h2>
  ...
  <p>Le mot clé <strong>break</strong> permet d'interrompre une boucle et d'exécuter le code qui suit la boucle. Le mot clé <strong>continue</strong> permet de sauter le tour de boucle courant puis de continuer à exécuter la boucle.</p>
    ...
    <h2 id="py_chaine">Manipuler des chaînes de caractères</h2>
  ...
  chaine[i];
    ...
    <h3>Caster une chaîne de caractères</h3>
...
<h2 id="py_tableau">Les tableaux</h2>
...
<h2 id="py_dictionnaire">Les dictionnaires</h2>
...
for cle, valeur in dico.items():
  ...
  <h3>Propriétés d'un dictionnaire</h3>
  ...
  <h3>Définir les attributs d'un objet à partir d'un dictionnaire</h3>
...
<h3>Conversion d'un dictionnaire en chaìne</h3>
...
chaine = '#'.join(dico)</code></pre>
  ...
  <h3>Utiliser la méthode setdefault pour afficher la valeur d'une clé</h3>
...
print(dico.setdefault('couleur', 'blanche')</code></pre>
  ...
  <h2 id="py_fonction"> Les fonctions </h2>
  ...
  <h3>Utilisation de la fonction callback en Python</h3>
...
def autreFonction(maFonction, val):
  ...
  <h2 id="py_doc">Les docstrings</h2>
...
<pre><code class="language-svg">help(ma_fonction)</code></pre>
  ...
  <h2 id="py_exception">La gestion des exceptions</h2>
...
try: # division par 0
  ...
  <h2 id="py_objet"> La programmation objet</h2>
...
def __maMethodePrivee</code></pre>
  ...
  <h2 id="py_in_out">Input / Output</h2>
...
------------------------>
  ...
  <h2 id="py_environnement">Les environnements de travail</h2>
...
pyenv which python</code></pre>
  ...
  <h3>Particularité de l'utilisation de Anaconda</h3>
  ...
  <h2 id="py_env">Créer des environnements de développement avec venv</h2>
...
pyenv local 3.8.0</code></pre>
  ...
  <h2 id="py_pycharm">Utilisation de PyCharm dans un environnement particulier</h2>
  ...
  <h2 id="#py_interface">Les interfaces graphiques</h2>


  <!------ ARGPARSE ------->

  <h3 id="py_argparse">L'interface en ligne de commande avec argparse</h3>
...
if args.collect:
  ...
  <h3 id="py_tkinter">L'interface graphique avec Tkinter</h3>
...
class InterfaceAccueil(Frame):
  ...
  <h2 id="py-pep">Respect du PEP8</h2>
...
pylint fichier.py // lance l'analyse de fichier.py</pre>
  ...
  <h2 id="py_django">Le framework Django</h2>
...
python manage.py runserver</code></pre>
  ...
  --------------------------------------->
  <h2>Exécuter du bash dans du code Python</h2>
