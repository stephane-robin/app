...
<aside>
  <nav id="table_matieres">
    <a href="#generalite">Structure du code</a>
    <a href="#hello">Hello world</a>
    <a href="#variable">Les variables</a>
    <a href="#chaine">Chaînes de caractères</a>
    <a href="">les listes</a>
    <a href="#tableau">Les tableaux</a>
    <a href="">Les dictionnaires</a>
    <a href="#condition">Les conditions</a>
    <a href="#boucle">Les boucles</a>
    <a href="#saisie">Saisie utilisateur</a>
    <a href="">Input/Output</a>
    <a href="#fonction">Les fonctions</a>
    <a href="">Gestion des exceptions</a>
    <a href="#poo">Programmation objet</a>
  </nav>
</aside>
...
<h2 id="generalite"> Généralités </h2>
...
<h2 id="chaine">Manipuler des chaînes de caractères</h2>
...
<h2 id="saisie">Saisie d'une valeur par l'utilisateur</h2>
...
alert(`Hello world ${nom}`);</code></pre>
  ...
  <h2 id="condition">Les conditions</h2>
  ...
  instructions;
    ...
    <h3>Particularité de JavaScript</h3>
...
alert(maVariable("Hervé"));</code></pre>
  ...
  <h2 id="poo"> Les objets en JavaScript </h2>
